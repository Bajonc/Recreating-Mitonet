...
My Modifications:
--------------
- Added filtering of instances smaller than a configured area
...
def merge_semantic_and_instance(
    ...
    Args:
        ...
        thing_area: An integer, remove things whose area is less than thing_area
    ...
    for ins_id in instance_ids:
        ...
        if torch.count_nonzero(thing_mask) <= thing_area:
            continue
